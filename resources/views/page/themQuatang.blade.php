...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="{{route('trang-quatang')}}">Quản lý Quà Tặng</a>/Thêm quà tặng</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Thêm quà tặng</h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-lg-12">
				<form action="{{route('them-quatang')}}" method="post" class="form-horizontal">
				...
				<div class="row"><h3 style="text-align: center;">@if(Session::has('thongbao')){{Session::get('thongbao')}}@endif</h3><br></div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="name" placeholder="Tên quà tặng" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="quantity">Số lượng*</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="quantity" placeholder="Số lượng" required>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="point">Số điểm*</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="point" placeholder="Số điểm" required>
							</div>
						</div>
						<div class="form-group">
							<label for="notes" class="control-label col-sm-2">Ghi chú: </label>
							<div class="col-sm-10">
							<textarea name="notes" name="notes" class="ckeditor" ></textarea>
							    <script>
